...
namespace JewellersHands
{
    ...
    {
        public SampleCsEtoOrderCurvesCommand()
        {
        ...
        public static SampleCsEtoOrderCurvesCommand Instance { get; private set; }

        public override string EnglishName => "JH_EtoSample";
